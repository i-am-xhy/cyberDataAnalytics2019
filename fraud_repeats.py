...
# safe = dpf.get_column(safe, 'card_id')
fraud = dpf.get_column(fraud, 'ip_id')

# print [ for key, group in groupby(fraud)]
# [print("key: {} group: {}".format(key, len(list(group)))) for key, group in groupby(safe)]
