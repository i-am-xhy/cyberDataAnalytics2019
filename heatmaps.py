...
get_annotated_categorical_heatmap(dictlist, column1, column2, 'Card type', 'Shopper interaction type', 'Fraud pressure by card issuer by shopper interaction type')
# get_annotated_categorical_heatmap(dictlist, column1, column2, countvalue=0)